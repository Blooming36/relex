...
import com.javaRelex.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .hasAnyAuthority("ROLE_ADMIN", "ROLE_USER").and()
                .authorizeHttpRequests().requestMatchers("/rating/**")
                .hasAnyAuthority("ROLE_ADMIN", "ROLE_USER").and()
                .authorizeHttpRequests().requestMatchers("/collecting/**")
                .hasAnyAuthority("ROLE_ADMIN", "ROLE_USER").and()
                .authorizeHttpRequests().requestMatchers("/statistic/**")
